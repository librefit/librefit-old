  ...
  <div>
    <section class="performance-facts">
      ...
      <table class="performance-facts__table">
        <tbody>
          <tr v-if="product.nutriments['energy-kcal_100g']">
          ...
          <tr v-if="product.nutriments.carbohydrates_value">
            ...
            <td>
              <b>{{ product.nutriments.carbohydrates_100g }}g</b>
            </td>
          </tr>
          ...
          <tr v-if="product.nutriments.proteins" class="thick-end">
            ...
            <td>{{ product.nutriments.proteins_100g }} {{ unit }}</td>
          </tr>
        </tbody>
      </table>
      <p class="text-center">
